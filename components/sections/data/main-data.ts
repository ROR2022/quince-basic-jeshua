export const quinceMainData = {
  ...
  event: {
    celebrant: "Jeshua",
    parents: {
      father: "Raúl Bousieguez Lizarraga",
      mother: "Milca Páez Lizarraga",
      ...
      backgroundVideo: "/video/bx2.mp4",
    },
    //Padrino Ma. Asunción Ramirez y Juan Gutiérrez
    godparents: {
      godfather: "Ivan de Jesús Garzón Zatarain",
      godmother: "Arely Elizabeth Roman Bousieguez",
    },
    madrinas:{
    ...
    abuelos: {
      maternos: {
        abuelo: "Gilberto Páez Macías",
        abuela: "Ubaldina Lizarraga Coronado",
      },
      paternos: {
        abuelo: "Roberto Bousieguez Bergez",
        abuela: "Elva Lizarraga Velarde",
      },
      backgroundVideo: "/video/bx3.mp4",
    },
    date: {
      full: "Domingo 28 de Diciembre 2025",
      isoDate: "2025-12-28T17:00:00",
      day: "Domingo",
      dayNumber: "28",
      month: "Diciembre",
      year: "2025",
    ...
    ceremony: {
      time: "17:00 hrs.",
      venue: "EL COBERTIZO",
      address: "82233 El Recodo, Sinaloa.",
      type: "Misa de Acción de Gracias",
      ubiLink: "https://maps.app.goo.gl/ZbNgzSVngFemphxY7",
  ...
  dressCode:{
    ...
    subtitle: "Código de vestimenta formal - Azul cielo solo la quinceañera",
  ...
  attendance: {
    whatsappNumber: "5215578480467", //+52 1 55 7848 0467
